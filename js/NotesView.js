export default class NotesView {
  constructor(
    ...
    this.root.innerHTML = `
      <div class="notes__sidebar">
        <h2 class="app__title">Notes App</h2>
    ...
    // TODO: Hide the notes preview by default
    this.updateNotePreviewVisibility(false);
  }

  _createListItemHMTL(id, title, body, updated) {
  ...
  updateNoteList(notes) {
    ...
    for (const note of notes) {
      const html = this._createListItemHMTL(
        note.id,
        note.title,
        note.body,
    ...
    // Add select/ delete event listeners for each notes list item
